...
public class DraftPaging implements Serializable{
	...
	public DraftPaging(int pageSize, int firstPageNo, int prevPageNo, int startPageNo, int pageNo, int endPageNo,
			int nextPageNo, int finalPageNo, int totalCount) {
		super();
	...
	public String toString() {
		return "DraftPaging [pageSize=" + pageSize + ", firstPageNo=" + firstPageNo + ", prevPageNo=" + prevPageNo
