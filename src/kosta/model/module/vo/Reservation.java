...
public class Reservation implements Serializable {
	...
	private int m_id;
	private List<MeetingRoom> mroomList;
	
	public Reservation(){}

	public Reservation(int rv_id, String m_title, String start_dt, String end_dt, String dept, String rv_user,
			String rv_writer, String reg_dt, String up_dt, int m_id, List<MeetingRoom> mroomList) {
		super();
		this.rv_id = rv_id;
	...
	public List<MeetingRoom> getMroomList() {
		return mroomList;
	}



	public void setMroomList(List<MeetingRoom> mroomList) {
		this.mroomList = mroomList;
	}
	...
	public String toString() {
		return "Reservation [rv_id=" + rv_id + ", m_title=" + m_title + ", start_dt=" + start_dt + ", end_dt=" + end_dt
				+ ", dept=" + dept + ", rv_user=" + rv_user + ", rv_writer=" + rv_writer + ", reg_dt=" + reg_dt
				+ ", up_dt=" + up_dt + ", m_id=" + m_id + ", mroomList=" + mroomList + "]";
	}
